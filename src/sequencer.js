...
Sequencer.prototype.run = function(){
  ...
  this.interval = window.setInterval(function(){
    ...
    that.position++;
    document.getElementById("done").style.width = 100 - (100 * (parseFloat(that.position) / that.steps)) - 2 + "%"

    document.getElementById("doing").style.width = (100 * parseFloat(that.position) / that.steps) - 2 + "%"
